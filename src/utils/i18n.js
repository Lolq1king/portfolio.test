  ...
  initTranslations() {
    this.translations = {
      pl: {
        ...
        'crt-close': '[ X ] ZAMKNIJ',
        'crt-tab-1': 'STATUS POSTACI',
        'crt-tab-2': 'KSIĘGA UMIEJĘTNOŚCI',
        'crt-tab-3': 'KRUK POCZTOWY',
      ...
      en: {
        ...
        'crt-close': '[ X ] CLOSE',
        'crt-tab-1': 'CHARACTER STATUS',
        'crt-tab-2': 'SKILL BOOK',
        'crt-tab-3': 'POSTAL RAVEN',
        ...
        'shelf-series-tag-3-1-name': "SERIES: THE DARK HERBALIST (Vol 1-3)",
